...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url(); ?>"><b><img src="<?php echo base_url(); ?>public/images/KT.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"  style="width:65px;">&nbsp;&nbsp; Administration</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
